...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = ((letter.classList.contains("valid")) && (capital.classList.contains("invalid")) && (number.classList.contains("valid")) && (length.classList.contains("valid")) && (match.classList.contains("valid"))); // TODO: Replace false with the correct condition
    if(condition) {
